...
\section{Prototype}
Til vores prototype har vi lavet en række skærmbilleder som viser vores forstilling af et eventuelt system kunne se ud fra brugerens synspunkt.\\
Det første brugeren vil blive mødt af er en forside, hvro han/hun har tre muligheder: finde en vare, lave indkøbsliste og finde de nærmeste supermarked.\\
\fbox{\includegraphics[scale=0.35]{FivaProto/fivaforside.png}} \\
\newpage
\noindent Her har brugeren trykket på find vare på forsiden. Det første han møder er en søgebare, hvor brugeren kan indtaste sin søgning og systemet vil komme med forslag imens brugeren søger.\\
Dernæst ses søgeresultaterne hvor brugeren kan starte navigationen hen til varen ved at trykke på "find" eller tilføje til indkøbslisten, ved at trykke på "tilføj"\\
Det sidste billeder vise en rute hen til en vare.
\\
\noindent \fbox{\includegraphics[scale=0.435]{FivaProto/soegauto.png}}
\fbox{\includegraphics[scale=0.435]{FivaProto/soegeresultat.png}}
\fbox{\includegraphics[scale=0.435]{FivaProto/findenkeltvare.png}}
\newpage

Her har brugeren trykket på indkøbsliste på forsiden. Her bliver brugeren mødt af en indkøbsliste, hvor han tilføje vare ved at søge på dem ligesom når man skal finde en vare.\\
Derudover kan ryde liste, som bare fjerne alle vare på listen. Når brugeren har tilføjet alle de varer på listen, kan systemet lave en rute igennem hele butikken, som er hurtigt og sørger for at brugeren for alle sine varer på listen.\\

\noindent \fbox{\includegraphics[scale=0.435]{FivaProto/indkoebsliste.png}}
\fbox{\includegraphics[scale=0.435]{FivaProto/butiksnavigation.png}}\\
\\

\noindent Her har brugeren trykket på nærmeste supermarked, hvor en liste af supermarkeder bliver listet og brugeren kan vælge starte navigationen hen til en ad dem\\

\noindent \fbox{\includegraphics[scale=0.5]{FivaProto/naermestesupermarked.png}}
\fbox{\includegraphics[scale=0.435]{FivaProto/naermsupnavigation.png}}

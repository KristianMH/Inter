...
\begin{enumerate}
  ...
  \item Synes at tilføje og slet medlemmer var TBA
  \item Ild ikonet var forvirrene.
  \item nico mente, at systemet skulle være på dansk.
  \item Files/Gallery og Task/calender var ikke overskueligt.
  \item tasks kommer automatisk ind i kalender (positiv). 
  \item frustation over søgerbaren som dukker op og er svær at fjerne.

...
Testdeltagernes kommentarer er klassificeret i følgende kategorier: \\
 \begin{wrapfigure}{l}{0.08\textwidth}
  ...
  \includegraphics[scale=0.5]{Billeder/alvorligt}   \\
    \includegraphics[scale=0.7]{Billeder/kritisk}
\end{wrapfigure}\\ Godt. Denne måde at gøre tingene på syntes testdeltagerne godt om.Den kan tjene som forbillede for andre.\\ \\
...
\begin{center}
  \begin{tabular}{*{6}{|c}|}
    ...
    Spørgsmål & 1 & 2 & 3 & 4 & 5 \\
    \hline
    1 & \includegraphics[scale=0.2]{Billeder/godt}& & & &  \\
    2 & & & & &  \\
        \hline
    3 & & & & &  \\
    4 & & & & &  \\
